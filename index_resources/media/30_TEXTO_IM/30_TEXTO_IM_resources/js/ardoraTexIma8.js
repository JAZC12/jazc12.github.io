...
$("#goLeftBut").click(function() {window.open("30_TEXTO_IM7.htm","_self");});
$("#goLeftBut").keydown(function(e) {if (e.which != 9) {window.open("30_TEXTO_IM7.htm","_self");}});
...
imaUp("30_TEXTO_IM_resources/media/menuFiles/8_15_pato.jpg");
});
...
if (e.which!=9){imaUp('30_TEXTO_IM_resources/media/imaLarge/ti_28__PATO.jpg');}});
});
