...
$("#goRightBut").click(function() {window.open("30_TEXTO_IM2.htm","_self");});
$("#goRightBut").keydown(function(e) {if (e.which != 9) {window.open("30_TEXTO_IM2.htm","_self");}});
...
imaUp("30_TEXTO_IM_resources/media/menuFiles/1_15_vaca.jpg");
});
$("#imaBut1").keydown(function(e) {if (e.which!=9) {
imaUp("30_TEXTO_IM_resources/media/menuFiles/1_15_vaca.jpg");
}});
$("#urlBut2").click(function(){window.open("https://www.youtube.com/watch?v=pQblfvSxH0I","_blank");});
$("#urlBut2").keydown(function(e){if (e.which!=9) {window.open("https://www.youtube.com/watch?v=pQblfvSxH0I","_blank");}});
...
if (e.which!=9){imaUp('30_TEXTO_IM_resources/media/imaLarge/ti_28__VACA.jpg');}});
});
