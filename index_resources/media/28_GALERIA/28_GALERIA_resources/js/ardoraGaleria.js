...
$("#ardoraMain").append("<div id='"+imaN+"' class='photoMG'><img src='28_GALERIA_resources/media/imaMG/" + fileIma[num-1] + "'/></div>");
...
fullS(num);
if ($.trim(txt[num-1])){
$("#" + imaN).append("<div  id='" + upN + "' class='bUp' title='DESCRIPCION'>I</div>");
...
$("#upN").focus(function(e){$(this).css("color","#000000")});
...
$("#" + nextN).focus(function(e){$(this).css("color","#000000")});
...
$("#" + prevN).focus(function(e){$(this).css("color","#000000")});
...
$("#" + titN).focus(function(e){$(this).css("color","#000000")});
...
$("#"+imaN).append("<img src='28_GALERIA_resources/media/imaMG/" + fileIma[num-1] + "'/>");
}else{
$("#"+imaN+ " img").remove();
if (conType[num-1]=="0"){
...
$("#txtN").focus(function(e){$(this).css("color","#000000")});
...
$("#" + fullN).focus(function(e){$(this).css("color","#000000")});
$("#" + fullN).blur(function(e){$(this).css("color","#808080")});
}
function showImaFull(num){
$("#ardoraMain").append("<div id='imaFull'><img alt='"+altIma[num - 1]+"' src='28_GALERIA_resources/media/imaFull/f_" + fileIma[num-1].substring(2) + "'/></div>");
cssColors();
...
$("#titF").focus(function(e){$(this).css("color","#000000")});
$("#titF").blur(function(e){$(this).css("color","#808080")});
$("#nextF").focus(function(e){$(this).css("color","#000000")});
$("#nextF").blur(function(e){$(this).css("color","#808080")});
$("#prevF").focus(function(e){$(this).css("color","#000000")});
$("#prevF").blur(function(e){$(this).css("color","#808080")});
$("#txtF").focus(function(e){$(this).css("color","#000000")});
...
$("#imaFull").append("<img alt='"+altIma[num-1]+"' src='28_GALERIA_resources/media/imaFull/f_"+fileIma[num-1].substring(2)+"'/>");
...
if ($.trim(fileMP3[num-1])){sourceLine=sourceLine+"<source src='28_GALERIA_resources/media/"+fileMP3[num-1]+"' type='audio/mp3' />";}
if ($.trim(fileOgg[num-1])) {sourceLine=sourceLine+"<source src='28_GALERIA_resources/media/"+fileOgg[num-1]+"' type='audio/ogg' />";}
$("#imaFull").append("<div  id='playF' class='playerAudio'><audio controls='controls'>"+sourceLine+"</audio></div>");}});}
if ($.trim(itemHelp[num - 1])) {$("#imaFull").append("<div class='titleIma'><p>" + itemHelp[num - 1] + "</p></div>");}
if ($.trim(txt[num - 1])) {$("#imaFull").append("<div  id='upF' class='bUp' title='DESCRIPCION'>I</div>");
...
sourceLine=sourceLine+"<source src='28_GALERIA_resources/media/"+fileMP3[num-1]+"' type='audio/mp3' />";}
if ($.trim(fileOgg[num-1])) {
sourceLine=sourceLine+"<source src='28_GALERIA_resources/media/"+fileOgg[num-1]+"' type='audio/ogg'/>";}
...
$("#musN").focus(function(e){$(this).css("color","#000000")});
