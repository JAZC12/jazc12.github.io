...
var canWidth = $("#ardoraAct").css("width").replace("px", "");var canHeight = $("#ardoraAct").height()+$("#origin").height()+20+20+10;$("#ardoraActCanvas").attr({"width": canWidth,"height": canHeight})
var oldTypeGame=typeGame;typeGame=99;isShowMessage=true; if (typeMessage=="Ok"){ var textMessage=messageOk; var urlMessage=urlOk; var goURLTarget= goURLOk; var borderColor=borderOk;}
